...
export default function ToastForChangeInfo({dialogOpen, snackbarOpen, buttonLoading, setSnackbarOpen, handleCancel, changeName}: Props) {
  return (
    <>
      <Dialog open={dialogOpen} onClose={handleCancel}>
        <DialogTitle>Email Change Confirmation</DialogTitle>
        <DialogContent>Are you sure to change your email? <strong className='text-red-500'>After this process, you will logged out. Please login again.</strong></DialogContent>
        <DialogActions>
